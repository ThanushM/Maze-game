...
void frontscreen(void)
{
	...
	glLoadIdentity();
	glColor3f(1, 1, 1);
	drawstring(120, 5, (char*) " Press ENTER to go To next screen", GLUT_BITMAP_HELVETICA_18);
	drawstring(-45, 5, (char*) "Maximize window for better view", GLUT_BITMAP_HELVETICA_12);
	glColor3f(1, 1, 1);
	output(5, 160, (char*)" COLLEGE OF ENGINEERING");
	glColor3f(1, 1, 1);
	output(10.0, 150, (char*) "DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	glColor3f(1, 0, 1);
	output(60, 130, (char*)"A Mini Project On:-");
	glColor3f(0, 1, 0.5);
	output(38, 120, (char*)"\"PATH FINDING USING OPENGL\"");
	glColor3f(1, 0, 1);
	output(40, 100, (char*)"By :");
	glBegin(GL_LINES);
	glVertex2f(40, 98);
	glVertex2f(50, 98);
	glEnd();
	glColor3f(1, 0, 0);
	output(40, 90, (char*) "tejaas and thanush ");

	output(40, 80, (char*)"");
	glColor3f(1, 0, 1);
	output(40, 60, (char*)"Under the Guidence of :");
	glBegin(GL_LINES);
	glVertex2f(40, 58);
	glVertex2f(98, 58);
	glEnd();
	...
	output(40, 50, (char*) "");
	glColor3f(1, 0, 0);
	drawstring(72, 50, (char*)"google", GLUT_BITMAP_HELVETICA_12);
	glColor3f(1, 0, 0);
	output(70, 40, (char*)"(and myself)");
	glColor3f(1, 0, 0);
	output(40, 30, (char*)"");
	glColor3f(1, 0, 0);
	drawstring(72, 30, (char*)"(B.E.)", GLUT_BITMAP_HELVETICA_12);

	output(70, 20, (char*) "Lecturer,Dept. of CSE");
	glFlush();
...
void winscreen()
{
	...
	output(55, 120, (char*)"CONGRATS!!!");
	glColor3f(1.0, 0.0, 1.0);
	output(15, 100, (char*)"YOU HAVE SUCCEEDED IN FINDING OUT THE PATH");
	output(35, 60, (char*) "* PRESS ESC TO GO TO MAIN MENU");
	output(35, 45, (char*)"* PRESS 1 TO RESTART THE GAME");
	glFlush();
}
void startscreen()
{
	...
	glClear(GL_COLOR_BUFFER_BIT);
	glColor3f(0.0, 1.0, 0.0);
	output(25, 140, (char*)"WELCOME TO THE GAME FINDING THE PATH");
	output(50, 100, (char*) "1.NEW GAME");
	output(50, 80, (char*)"2.INSTRUCTIONS");
	output(50, 60, (char*) "3.QUIT");
	glFlush();
}
...
void instructions()
{
	...
	output(45, 140, (char*) "INSTRUCTIONS:");
	glBegin(GL_LINES);
	glVertex2f(45, 138);
	glVertex2f(90, 138);
	glEnd();
	glColor3f(0, 1, 0);
	output(-20, 120, (char*)"* TO MOVE THE POINT USE ARROW KEYS");
	output(-20, 100, (char*) "* FIND THE WAY TO MOVE INTO THE MAZE AND GET OUT");
	output(-20, 80, (char*)"* GREEN COLOURED POINT INDICATE THE POINT FROM WHERE YOU HAVE TO START");
	output(-20, 60, (char*) "* RED COLOURED POINT INDICATE THE POINT WHERE YOU HAVE TO REACH");
	output(-20, 40, (char*) "* YOU WILL HAVE TO HURRY AS YOU HAVE LIMITED TIME");
	output(-20, 20, (char*) "* PRESS ESC TO GO TO MAIN MENU");
	glFlush();
}
...
void timeover()
{
	glClear(GL_COLOR_BUFFER_BIT);
	glColor3f(1.0, 0, 0);
	output(70, 110, (char*)"TIMEOVER");
	glColor3f(0, 1, 0);
	output(50, 100, (char*)"YOU HAVE LOST THE GAME");
	output(50, 90, (char*)"BETTER LUCK NEXT TIME");
	output(40, 40, (char*) "* PRESS ESC TO GO TO MAIN MENU");
	output(40, 30, (char*)"* PRESS 1 TO RESTART THE GAME");
	glFlush();
}
